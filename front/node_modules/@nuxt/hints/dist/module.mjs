import { addDevServerHandler, useNuxt, defineNuxtModule, createResolver, addTemplate, addPlugin, addComponent, addBuildPlugin, addServerPlugin } from '@nuxt/kit';
import { addCustomTab, onDevToolsInitialized, extendServerRpc } from '@nuxt/devtools-kit';
import { existsSync } from 'node:fs';
import { createRouter, eventHandler, proxyRequest } from 'h3';
import { joinURL } from 'ufo';
import { RPC_NAMESPACE } from '../dist/runtime/core/rpc-types.js';
import { getHandler, postHandler, deleteHandler, clearHydrationMismatches, getHydrationMismatches } from '../dist/runtime/hydration/handlers.js';
import { getHandler as getHandler$1, postHandler as postHandler$1, deleteHandler as deleteHandler$1, clearLazyLoadHint, getLazyLoadHints } from '../dist/runtime/lazy-load/handlers.js';
import { getHandler as getHandler$2, postHandler as postHandler$2, deleteHandler as deleteHandler$2, clearHtmlValidateReport, getHtmlValidateReports } from '../dist/runtime/html-validate/api-handlers.js';
...
function createHintsRouter() {
  ...
  router.get("/hydration", getHandler);
  router.post("/hydration", postHandler);
  router.delete("/hydration", deleteHandler);
  router.get("/lazy-load", getHandler$1);
  router.post("/lazy-load", postHandler$1);
  router.delete("/lazy-load/:id", deleteHandler$1);
  router.get("/html-validate", getHandler$2);
  router.post("/html-validate", postHandler$2);
  router.delete("/html-validate/:id", deleteHandler$2);
  return router;
}
